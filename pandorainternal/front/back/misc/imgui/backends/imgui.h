...
namespace ImGui
{
    ...
    IMGUI_API void          CheckboxKeybind(const char* label, bool* v, int* key, int* mode = 0);
    ...
    IMGUI_API bool          CustomImage(const char* id, ImTextureID texture_id, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, ImU32 tint_col, ImGuiButtonFlags flags = 0);
    ...
    IMGUI_API bool          DefaultBeginChildFrame(ImGuiID id, const ImVec2& size, ImGuiWindowFlags flags = 0); // helper to create a child window / scrolling region that looks like a normal widget frame
    IMGUI_API void          DefaultEndChildFrame();
    // Text Utilities
